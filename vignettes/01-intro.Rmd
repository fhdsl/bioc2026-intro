...
author: Ted Laderas^[tladera2@fredhutch.org]
...
SE <- DESeqDataSet(SE, design = ~ sex + time)  #make DESeqDataset
SE <- SE[rowSums(assay(SE)) > 5,] #filter out low expressing candidates
SE <- DESeq(SE) #run estimateSizeFactors, estimateDispersions, nbinomialWaldTest
```
